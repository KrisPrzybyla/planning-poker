...
describe('FibonacciCard', () => {
  ...
  it('renders card with correct value', () => {
    renderWithChakra(
      <FibonacciCard value="5" onClick={mockOnClick} isSelected={false} isDisabled={false} />
    );
  ...
  it('calls onClick when clicked', () => {
    renderWithChakra(
      <FibonacciCard value="8" onClick={mockOnClick} isSelected={false} isDisabled={false} />
    );
  ...
  it('shows selected state correctly', () => {
    renderWithChakra(
      <FibonacciCard value="13" onClick={mockOnClick} isSelected={true} isDisabled={false} />
    );
  ...
  it('is disabled when isDisabled prop is true', () => {
    renderWithChakra(
      <FibonacciCard value="21" onClick={mockOnClick} isSelected={false} isDisabled={true} />
    );
  ...
  it('handles special values like "?" correctly', () => {
    renderWithChakra(
      <FibonacciCard value="?" onClick={mockOnClick} isSelected={false} isDisabled={false} />
    );
